            ...
            child: SingleChildScrollView(
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    const Icon(Icons.bakery_dining_rounded, color: AppColors.warmBrown, size: 54),
                    const SizedBox(height: 18),
                    Text(_isSignup ? 'Create your bakery map' : 'Welcome back',
                        style: const TextStyle(fontSize: 34, height: 1, fontWeight: FontWeight.w900)),
                    const SizedBox(height: 8),
                    const Text('Find warm cafes, save favorites, and reserve your next sweet stop.',
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: AppColors.warmBrown.withValues(alpha: 0.12), blurRadius: 28, offset: const Offset(0, 18))],
                      ),
                      child: Form(
                        key: _formKey,
                        child: Column(
